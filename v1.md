...
- All secrets (JWT private key, DB URL, Redis URL, Google client secret,
  SAML certificates) must come from environment variables. No hardcoded values.
...
reachable. Returns 503 otherwise.
...
service passes its readiness probe. No secrets or credentials appear anywhere in committed files.
