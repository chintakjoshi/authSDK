...
The cookie names in this example match the local HTTP browser-session baseline.
In HTTPS production, use the names configured in authSDK, often
`__Host-auth_access` and `__Host-auth_csrf`.
